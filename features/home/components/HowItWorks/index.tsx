      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-10 overflow-hidden lg:mx-0 lg:max-w-none lg:grid-cols-4 lg:gap-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-4 text-lg/6 font-semibold tracking-tight text-gray-900">Связываем диалоги с итогом сделки</p>
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-4 text-lg/6 font-semibold tracking-tight text-gray-900">Находим приёмы, которые работают</p>
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-4 text-lg/6 font-semibold tracking-tight text-gray-900">Внедряем и перепроверяем</p>
